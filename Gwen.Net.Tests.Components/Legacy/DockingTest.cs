...
public class DockingTest : GUnit
{
    ...
    {
        Slider val = (Slider) control;
        Int32 i = (Int32) val.Value;
    ...
    private void DockChanged(ControlBase control, EventArgs args)
    {
        ControlBase? inner = (ControlBase) control.UserData;
        RadioButtonGroup rbg = (RadioButtonGroup) control;
        ControlBase? gb = (ControlBase) inner.UserData;
        Int32 w = (Int32) ((Slider) gb.FindChildByName("Width", recursive: true)).Value;
        Int32 h = (Int32) ((Slider) gb.FindChildByName("Height", recursive: true)).Value;
