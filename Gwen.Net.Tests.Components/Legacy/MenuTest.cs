            ...
            : base(parent)
        {
            /* Menu Strip */
            {
                ...
                /* File */
                {
                    ...
                    root.Menu.AddItem("Load", "Legacy/test16.png", "Ctrl+L").SetAction(MenuItemSelect);
                ...
                /* Russian */
                {
                    ...
                    pRoot.Menu.AddItem("\u0111\u01A1n v\u1ECB th\u1EED nghi\u1EC7m", "Legacy/test16.png")
                ...
                /* Embedded Menu Items */
                {
...

                    {
                        ...
                        pRootB.Menu.AddItem("Two.Nine", "Legacy/test16.png");
                    }
...

                    {
                        ...
                        pRootB.Menu.AddItem("Six.Five", "Legacy/test16.png");
