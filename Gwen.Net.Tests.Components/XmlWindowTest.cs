...
";
            ...
            : base(parent)
        {
            ...
            Button button1 = new(layout);
            button1.Text = "Open a Window (method)";
            button1.Clicked += OpenMethodWindow;

            Button button2 = new(layout);
            button2.Text = "Open a Window (interface)";
            button2.Clicked += OpenInterfaceWindow;
        }

        private void OpenMethodWindow(ControlBase control, EventArgs args)
        {
            new MethodTestComponent(this, m_xml);
        }

        private void OpenInterfaceWindow(ControlBase control, EventArgs args)
        {
        ...
        private class InterfaceTestComponent : Component
        {
            ...
            public override bool HandleEvent(string eventName, string handlerName, ControlBase sender, EventArgs args)
            {
                ...
                if (handlerName == "OnSelectionChanged")
                {
                    m_unit.UnitPrint(
