...
using Color = Gwen.Net.Legacy.Color;
using Font = Gwen.Net.Legacy.Font;
using FontStyle = System.Drawing.FontStyle;
using PixelFormat = System.Drawing.Imaging.PixelFormat;
using Point = Gwen.Net.Legacy.Point;
using Rectangle = Gwen.Net.Legacy.Rectangle;
using Size = Gwen.Net.Legacy.Size;

namespace Gwen.Net.OpenTk.Legacy.Renderers;
...
public abstract class OpenTkRendererBase : RendererBase
{
        ...
        Single v2 = 1)
    {
        ...
        Int32 tex = (Int32) t.RendererData;
        rect = Translate(rect);
    ...
    public override unsafe Color PixelColor(Texture texture, UInt32 x, UInt32 y, Color defaultColor)
    {
        ...
        Int32 tex = (Int32) texture.RendererData;
