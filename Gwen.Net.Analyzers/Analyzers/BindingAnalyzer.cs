...
public sealed class BindingAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeInvocation(SyntaxNodeAnalysisContext context)
    {
        ...
        if (containingType.OriginalDefinition.ToDisplayString() != "Gwen.Net.New.Bindings.Binding<T>"
            && containingType.OriginalDefinition.ToDisplayString() != "Gwen.Net.New.Bindings.Binding")
