...
public enum Enablement
{
    ...
    /// <summary>
    /// The element is read-only. It can still receive focus and might react to input, but should not write to the model or execute commands.
    /// This state is necessary as for example creating a read-only view would not be possible with just disabled, as disabling would also disable scroll controls and such.
    /// </summary>
    ReadOnly = 1,
