...
public static class Command
{
    ...
    /// <summary>
    /// Create a command from an action with an argument. The command will always be executable and will return a successful execution when executed.
    /// </summary>
    /// <param name="action">The action to execute when the command is executed. The argument passed to the command will be passed to the action.</param>
