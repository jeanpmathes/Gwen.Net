...
public class CrossSplitter : ControlBase
{
    ...
    protected override Size Measure(Size availableSize)
    {
        ...
        Int32 h = (Int32) ((availableSize.Width - SplitterSize) * hVal);
        Int32 v = (Int32) ((availableSize.Height - SplitterSize) * vVal);
    ...
    {
        Int32 h = (Int32) ((finalSize.Width - SplitterSize) * hVal);
        Int32 v = (Int32) ((finalSize.Height - SplitterSize) * vVal);
