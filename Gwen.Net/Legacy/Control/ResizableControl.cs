...
public class ResizableControl : ContentControl
{
    ...
    public ResizableControl(ControlBase parent)
        : base(parent)
    {
        resizerGroup = new Resizer[8];
        MinimumSize = new Size(width: 5, height: 5);
        ClampMovement = false;

        Resizer resizer;

        resizer = resizerGroup[(Int32) ResizerPos.Bottom] = new Resizer(this);
        resizer.ResizeDir = Dock.Bottom;
        resizer.Resized += OnResized;
        resizer.Target = this;

        resizer = resizerGroup[(Int32) ResizerPos.LeftBottom] = new Resizer(this);
        resizer.ResizeDir = Dock.Bottom | Dock.Left;
        resizer.Resized += OnResized;
        resizer.Target = this;

        resizer = resizerGroup[(Int32) ResizerPos.RightBottom] = new Resizer(this);
        resizer.ResizeDir = Dock.Bottom | Dock.Right;
        resizer.Resized += OnResized;
        resizer.Target = this;

        resizer = resizerGroup[(Int32) ResizerPos.Top] = new Resizer(this);
        resizer.ResizeDir = Dock.Top;
        resizer.Resized += OnResized;
        resizer.Target = this;

        resizer = resizerGroup[(Int32) ResizerPos.LeftTop] = new Resizer(this);
        resizer.ResizeDir = Dock.Left | Dock.Top;
        resizer.Resized += OnResized;
        resizer.Target = this;

        resizer = resizerGroup[(Int32) ResizerPos.RightTop] = new Resizer(this);
        resizer.ResizeDir = Dock.Right | Dock.Top;
        resizer.Resized += OnResized;
        resizer.Target = this;

        resizer = resizerGroup[(Int32) ResizerPos.Left] = new Resizer(this);
        resizer.ResizeDir = Dock.Left;
        resizer.Resized += OnResized;
        resizer.Target = this;

        resizer = resizerGroup[(Int32) ResizerPos.Right] = new Resizer(this);
