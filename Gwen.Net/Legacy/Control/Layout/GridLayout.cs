...
public class GridLayout : ControlBase
{
    ...
    protected override Size Measure(Size availableSize)
    {
        ...
        Int32 usedWidthForRelativeSize = 0;
        Int32 usedHeightForRelativeSize = 0;
        Int32 currentHeightForRelativeSize = 0;
