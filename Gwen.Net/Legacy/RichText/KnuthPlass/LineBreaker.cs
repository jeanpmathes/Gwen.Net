...
internal class LineBreaker : RichText.LineBreaker
{
    ...
    public override List<TextBlock> LineBreak(Paragraph currentParagraph, Int32 width)
    {
        ...
        for (Int32 currentTolerance = 4; currentTolerance < 30; currentTolerance += 2)
        {
    ...
    private void MainLoop(Int32 index)
    {
        ...
        while (active != null)
        {
            ...
            while (active != null)
            {
                ...
                {
                    Int32 badness = (Int32) (100.0f * Math.Pow(Math.Abs(ratio), y: 3));
            ...
            for (fitnessClass = 0; fitnessClass < candidates.Length; fitnessClass++)
            {
                ...
                {
                    LinkedListNode<BreakPoint> newNode = new(
                        new BreakPoint(
                            index,
                            candidate.Demerits,
                            candidate.Ratio,
